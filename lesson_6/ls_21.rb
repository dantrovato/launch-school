...
def output(player_cards, player_total, dealer_cards, dealer_total)
  puts "=============="
...
loop do
  ...
  loop do
    ...
    if busted?(player_cards)
      ...
      output(player_cards, player_total, dealer_cards, dealer_total)
    end
    ...
    break if dealer_score == 2 || player_score == 2
  end
  prompt "Player score is #{player_score}. Dealer score is #{dealer_score}."
  break
end
