...
def triangle(first, second, third)
  # => orders highest to lowest into first, second and third
  first, second, third = [first, second, third].max(3)
...
The thing is, we don't know which of our sides was chosen as the "largest" when we
call max on sides. So, to check for this, we make sure that the total sum of the
side lengths is greater than 2 times the largest side. Another way to express this
