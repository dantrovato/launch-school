...
Discussion
This one is interesting. First, we must require the Date class, since that class
isn't part of the core library. This problem asks us to find all Friday the 13ths
in a given year. To do this is, we step through each month of the year and look
  at the 13th of the month; if it's a Friday, we increment unlucky_count.
